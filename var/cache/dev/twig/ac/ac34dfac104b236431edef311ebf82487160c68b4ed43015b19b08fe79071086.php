...
/* base.html.twig */
class __TwigTemplate_e4d093d4adbe59568bcf114963e3562af92d2feace8f3aa0f04b9f4d433f343f extends Template
{
    private $source;
    private $macros = [];
...
<html>
    ...
    <body>
        ...
        if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_USER")) {
            ...
            echo "\" class=\"btn btn-outline-danger me-4\" >Выход</a>
                    ";
        } else {
            // line 26
            echo "                        <a href=\"";
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_login");
            echo "\" class=\"btn btn-outline-success me-4\">Вход</a>
                        <a href=\"";
            // line 27
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_register");
            echo "\" class=\"btn btn-outline-info me-4\" >Регистрация</a>
                    ";
        }
        // line 29
        echo "                </div>
...
";
    ...
    {
        return array (  178 => 32,  168 => 16,  165 => 14,  155 => 13,  145 => 11,  142 => 9,  132 => 8,  113 => 5,  101 => 33,  99 => 32,  94 => 29,  89 => 27,  84 => 26,  79 => 24,  74 => 23,  72 => 22,  65 => 17,  63 => 13,  60 => 12,  57 => 8,  53 => 5,  47 => 1,);
    }
            ...
            <div class=\"container-fluid\">
                <div class=\"d-flex flex-row align-items-center\">
                    {% if is_granted('ROLE_USER') %}
                        {{ app.user.email }}
                        <a href=\"{{ path('app_logout') }}\" class=\"btn btn-outline-danger me-4\" >Выход</a>
                    {% else %}
                        <a href=\"{{ path('app_login') }}\" class=\"btn btn-outline-success me-4\">Вход</a>
                        <a href=\"{{ path('app_register') }}\" class=\"btn btn-outline-info me-4\" >Регистрация</a>
                    {% endif %}
                </div>
            </div>
        </nav>
